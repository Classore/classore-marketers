			...
			<div className="flex items-center gap-x-2">
				...
				<div className="">
					...
					<p className="text-xs text-neutral-400">
						{format(withdrawal.date, "MMM dd, HH:mm a")}
					</p>
				</div>
			</div>
			<div className="flex flex-col items-end">
				<p className="text-sm font-medium">{withdrawal.amount} Points</p>
				<div
					className={`flex w-fit items-center rounded-md px-3 py-0.5 text-xs capitalize ${STATUS_COLOR[withdrawal.status]}`}>
					{withdrawal.status}
				</div>
			</div>
		</div>
